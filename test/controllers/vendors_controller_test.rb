...
class VendorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vendor" do
    assert_difference('Vendor.count') do
      post vendors_url, params: { vendor: { price: @vendor.price, product: @vendor.product, vendor: @vendor.vendor } }
    end
  ...
  test "should update vendor" do
    patch vendor_url(@vendor), params: { vendor: { price: @vendor.price, product: @vendor.product, vendor: @vendor.vendor } }

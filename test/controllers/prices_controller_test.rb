...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { price: @price.price, product: @price.product, quantity: @price.quantity, quantity_discount: @price.quantity_discount, vendor: @price.vendor } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { price: @price.price, product: @price.product, quantity: @price.quantity, quantity_discount: @price.quantity_discount, vendor: @price.vendor } }

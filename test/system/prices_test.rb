...
class PricesTest < ApplicationSystemTestCase
  ...
  test "creating a Price" do
    ...
    fill_in "Product", with: @price.product
    fill_in "Quantity", with: @price.quantity
    fill_in "Quantity discount", with: @price.quantity_discount
    fill_in "Vendor", with: @price.vendor
